...
if __name__ == "__main__":
    ...
    parser.add_argument("-dtype", help="necessary input: damage type of the spell")
    parser.add_argument("-school", help="necessary input: school of the spell")
    parser.add_argument("--title" ,help="title in plot")
    parser.add_argument("--savename", help="name of the saved file")
    parser.add_argument("--legend", help="bool to print legend or not (0 = False; 1 = True)")  # TODO check if bool numbers are correct
    parser.add_argument("--breakdown", help="bool to control whether to breakdown the lines with colours")
